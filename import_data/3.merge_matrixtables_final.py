...
# pa10@sanger.ac.uk
# 18/01/2020
# Merge individual chromosome matrixtables to one WES matrixtables
# optional : annotate with cohort info. Commands are commented out currently
...
if __name__ == "__main__":
    ...
    #mt = annotate_samples_with_cohort_info(mt, table_cohort)
