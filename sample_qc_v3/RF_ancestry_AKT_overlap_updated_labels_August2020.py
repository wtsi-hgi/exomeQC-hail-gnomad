...
if __name__ == "__main__":
    ...
    pca_scores.write(
        f"{tmp_dir}/ddd-elgh-ukbb/pca_scores_after_pruning_aug2020.ht", overwrite=True)
    pca_loadings.write(
        f"{tmp_dir}/ddd-elgh-ukbb/pca_loadings_after_pruning_aug2020.ht", overwrite=True)
    with open(f"{temp_dir}/ddd-elgh-ukbb/pca_evals_after_pruning_aug2020.txt", 'w') as f:
   ...
   # population_assignment_table = assign_population_pcs(
    ...
    pop_ht.write(
        f"{tmp_dir}/ddd-elgh-ukbb/pop_assignments_updated_august2020.ht", overwrite=True)
    pop_ht.export(
        f"{temp_dir}/ddd-elgh-ukbb/pop_assignments_updated_august2020.tsv.gz")
