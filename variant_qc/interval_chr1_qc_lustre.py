...
if __name__ == "__main__":
    ...
    mt_split = mt_split.checkpoint(f"{lustre_dir}/checkpoints/{CHROMOSOME}-split-multi_checkpoint.mt",  overwrite=True)
    ...
    panda_df_unfiltered_table.export(f"{lustre_dir}/output-tables/{CHROMOSOME}_sampleQC_unfiltered.tsv.bgz", header=True)
    ...
    mt_vqslod_filtered = mt_vqslod_filtered.checkpoint(f"{lustre_dir}/checkpoints/{CHROMOSOME}_vqslod_filtered_checkpoint.mt", overwrite=True)
    ...
    filter_sampleqc_table.export(f"{lustre_dir}/output-tables/{CHROMOSOME}-sampleQC_filtered.tsv.bgz", header=True)
