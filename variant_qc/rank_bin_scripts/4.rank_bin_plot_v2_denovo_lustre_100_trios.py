...
def main(args):
    ...
    ht = hl.read_table(f'{lustre_dir}/variant_qc/models/{run_hash}_rf_result_FINAL_for_RANKING_100_trios.ht')
    ...
    if args.add_rank:
        ...
        ht_ranked = ht_ranked.checkpoint(
            f'{lustre_dir}/variant_qc/models/{run_hash}_rf_result_ranked_100trios.ht', overwrite=True)
    ...
    if args.add_bin:
        ...
        ht = hl.read_table(
            f'{lustre_dir}/variant_qc/models/{run_hash}_rf_result_ranked_100trios.ht')

       
        ht_bins = create_binned_data_initial(ht, "exomes", "RF", n_bins=100)
        ht_bins.write(
            f'{lustre_dir}/variant_qc/models/{run_hash}_rf_result_ranked_BINS_100trios.ht', overwrite=True)
