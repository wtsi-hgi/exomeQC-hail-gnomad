...
plot_dir="/lustre/scratch123/wes_jc_ukb_ibd/ruth_training_datasets/variantqc/"
...
def main(args):
    ...
    ht = hl.read_table(f'{lustre_dir}/MegaWES_for_RF_by_variant_type_all_cols.ht')
    ...
    if args.train_rf:
        ...
        with hl.hadoop_open(f'{plot_dir}/rf_runs.json', "w") as f:
            json.dump(rf_runs, f)
    ...
    if args.apply_rf:
        ...
        ht = hl.read_table(
            f'{lustre_dir}/variant_qc/models/{run_hash}/training.ht')
    ...
    if args.finalize:
        ...
        freq_ht = hl.read_table(
            f'{lustre_dir}//variantqc/Sanger_cohorts_chr1-20-XY_sampleQC_FILTERED_FREQ_adj.ht')
        freq = freq_ht[ht.key]
