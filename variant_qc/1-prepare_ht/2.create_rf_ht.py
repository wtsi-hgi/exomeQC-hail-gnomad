...
def main(args):
    ...
    outfile1 = lustre_dir + "MegaWES_for_RF_all_cols.ht"
    ht = ht.write(outfile1, overwrite=True)
    ht = median_impute_features(ht, strata={"variant_type": ht.variant_type})
    outfile2 = lustre_dir + "MegaWES_for_RF_by_variant_type_all_cols.ht"
    ht = ht.write(outfile2, overwrite=True)
