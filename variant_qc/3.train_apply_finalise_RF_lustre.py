...
def main(args):
    ...
    print("main table")
    ht = hl.read_table(
        f'{lustre_dir}/variant_qc/Sanger_table_for_RF_all_cols.ht')
    ...
    if args.finalize:
        ...
        freq_ht = hl.read_table(
            f'{lustre_dir}//variant_qc/Sanger_cohorts_chr1-20-XY_sampleQC_FILTERED_FREQ_adj.ht')
        freq = freq_ht[ht.key]
