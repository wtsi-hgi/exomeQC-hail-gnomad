...
def count_trans_untransmitted_singletons(mt_filtered, ht):
    ...
    '''
    mt_trans_count=mt_trans.group_cols_by(mt_trans.proband_entry.id,mt_trans.mother_entry.id, mt_trans.father_entry.id)(transmitted_singletons_count=hl.agg.count_where(
                               # (mt_trans.info.AC[0] == 2) &
                                (mt_trans.proband_entry.GT.is_non_ref()) &
                                (
                                (mt_trans.father_entry.GT.is_non_ref()  )
